        ...
        <div className="pt-24">
            <div>
                ...
                <div key={blog._id} className="border-2 border-teal-400 my-10">
                    ...
                    <img src={blog.image} className="w-full h-[400px]" alt="blog image" />
                    <h2 className="text-2xl font-semibold my-4 text-center bg-red-200 p-1 rounded-md md:w-[50%] mx-auto">{blog.title}</h2>
