...
const Banner = () => {
  return (
    <div className="relative h-[350px] md:h-[500px] bg-cover bg-center" style={{ backgroundImage: `url(${bannerImage})` }}>
      <div className="absolute inset-0 bg-[#00B3C7] opacity-50"></div>
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-white mt-10 text-center bg-red-600 opacity-80 p-4">
          <h1 className="md:text-4xl text-2xl font-bold mb-4">Donate blood, save lives.</h1>
